        ...
        {hasGithub ? (
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              {githubUsername && (
                <span className="text-text-muted text-sm">@{githubUsername}</span>
              )}
            </div>
            <p className="text-text-secondary text-sm mb-4">
              Your GitHub account is connected. AuditIQ can create Auto-Fix PRs in your repos.
            </p>
            <button
              onClick={() => signIn('github', { callbackUrl: '/dashboard?tab=settings' })}
              className="bg-bg-surface hover:bg-bg border border-border-subtle text-text-secondary text-sm px-4 py-2 rounded-lg transition-colors"
            >
              Reconnect GitHub
            </button>
          </div>
          ...
          <div>
            <p className="text-text-secondary text-sm mb-4">
              Connect your GitHub account to enable Auto-Fix PR — AuditIQ will automatically create pull requests with fixes applied.
            </p>
            <button
              onClick={() => signIn('github', { callbackUrl: '/dashboard?tab=settings' })}
              className="flex items-center gap-3 bg-gray-900 hover:bg-gray-800 border border-white/20 text-white px-5 py-2.5 rounded-xl font-medium transition-colors"
            >
